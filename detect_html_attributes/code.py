...
for ele in match:
    ...
    if ele[0] != "" and ele[0] != "":
        key = ele[0].replace("<","").replace(">","")
        val = ele[1].replace("=","").replace('"',"").replace("'","")
